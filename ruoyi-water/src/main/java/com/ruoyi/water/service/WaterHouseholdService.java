 ...
 * @Date 2024/12/18
 */
public interface WaterHouseholdService {
     ...
     * @return 是否成功
     */
    boolean insertWaterHousehold(WaterHousehold waterHousehold);
     ...
     * @return 是否成功
     */
    boolean updateWaterHousehold(WaterHousehold waterHousehold);
     ...
     * @return 是否成功
     */
    boolean deleteWaterHouseholdById(Long householdId);
     ...
     * @return 是否成功
     */
    boolean deleteWaterHouseholdByIds(Long[] householdIds);
     ...
     * @return 是否成功
     */
    boolean updateStatus(Long householdId, Integer status);
}
